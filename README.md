...
*The main purpose of this project is to help businesses:*
-Monitor sales performance
-Track product categories and brands
-Analyze regional sales trends
-Improve decision-making using data visualization

The dashboard includes KPI cards, bar charts, pie charts, maps, and filters for better business analysis and reporting.
